...
#        self.optional_args_le.setText(self.config.get('DEFAULT', 'optional_args', fallback=''))
        ...
        if self.config_path.exists() and os.path.getsize(self.config_path) > 0:
             ...
             self.cb.addItems(data['animal_type'])
...
#        directory = file_path
 #       directory=directory.joinpath(directory, 'tracked')         
