...
#        grid_layout = QGridLayout()
        ...
        # self.radioButton1 = QRadioButton("Default: Use .CSV file for model paths")
        # self.radioButton2 = QRadioButton("Manual model selection")
...
#        
        ...
        # self.use_csv_checkbox.stateChanged.connect(self.switch_csv_mode)
        # self.csv_layout.addWidget(self.use_csv_checkbox,0,0)
